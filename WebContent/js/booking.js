		            			...
		            			str +="<div class='order_di col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
				            			...
				            			"<div class='subscribe_div col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
				            				"<ul class='subscribe_ul col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
				            					...
				            					"<li class='subscribe_l3 col-lg-12 col-xs-12 col-md-12 col-sm-12'><a href='booking_date.html?mdcid="+data[i].MEDICALORDER_ID+"'>"+time+"更改日程</a><div class='closeyu' data-id='"+data[i].MEDICALORDER_ID+"'><input type='hidden' value='"+data[i].MEDICALORDER_ID+"'/>取消预约</div></li>"+
				            				"</ul>"+
				            			"</div>"+
				            			"<div class='add_date'>"+
