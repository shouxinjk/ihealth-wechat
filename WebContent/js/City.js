...
$._cityInfo = [{"n":"北京市","c":["北京市"]},
    ...
    {"n":"新疆维吾尔自治区","c":["乌鲁木齐市","克拉玛依市","吐鲁番市","哈密地区","阿克苏地区","喀什地区","和田地区","塔城地区","阿勒泰地区","克孜勒苏柯尔克孜自治州","昌吉回族自治州","博尔塔拉蒙古自治州","巴音郭楞蒙古自治州","伊犁哈萨克自治州"]},
    {"n":"内蒙古自治区","c":["呼和浩特","包头市","乌海市","赤峰市","通辽市","鄂尔多斯市","呼伦贝尔市","乌兰察布市","巴彦淖尔市"]}];
...
};$.initProv1 = function(prov, city, defaultProv, defaultCity) {
    var provEl = $(prov);
    var cityEl = $(city);
    var hasDefaultProv = (typeof(defaultCity) != 'undefined');
