	            			...
	            			if(data[i].MSTATUS == '已预约'){
		            			...
		            			str +="<div class='order_di col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
				            			...
				            			"<div class='subscribe_div col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
				            				"<ul class='subscribe_ul col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
				            					...
				            					"<li class='subscribe_l3 col-lg-12 col-xs-12 col-md-12 col-sm-12'><a href='booking_date_1.html?mdcid="+data[i].MEDICALORDER_ID+"&time="+time+"'>"+time+"更改日程</a><div class='closeyu' data-id='"+data[i].MEDICALORDER_ID+"'><input type='hidden' value='"+data[i].MEDICALORDER_ID+"'/>取消预约</div></li>"+
				            				"</ul>"+
				            			"</div>"+
				            			"<div class='add_date'>"+
		            			...
		            			"<div class='subscribe_div col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
		            				"<ul class='subscribe_ul col-lg-12 col-xs-12 col-md-12 col-sm-12'>"+
		            					"<li class='subscribe_l1 col-lg-12 col-xs-12 col-md-12 col-sm-12'><span>体检人:</span><i>"+data[i].UNAME+"</i></li>"+
		            					"<li class='subscribe_l2 col-lg-12 col-xs-12 col-md-12 col-sm-12'><span>订单编号:</span><i>"+data[i].ORDERNO+"</i>(子订单:<em>"+data[i].MEDICALORDERNO.substring(12,data[i].MEDICALORDERNO.length)+"</em>)</li>"+
		            					"<li class='subscribe_l3 col-lg-12 col-xs-12 col-md-12 col-sm-12'><a href='booking_date_1.html?mdcid="+data[i].MEDICALORDER_ID+"&time="+time+"'><input type='hidden' value='"+data[i].MEDICALORDER_ID+"' />预约日程</a></li>"+
		            				"</ul>"+
		            			"</div>"+
		            			"<div class='add_date'>"+
